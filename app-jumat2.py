...
def create_midi_file(params, output_path):
    ...
    try:
        ...
        # ####################################################################################
        # ### BARU: Menonaktifkan reverb (efek gema) untuk track rhythm/chords               ###
        # ####################################################################################
        tracks['rhythm_primary'].append(Message('control_change', channel=1, control=91, value=0, time=0)) # Reverb Level 0
        ...
        # ### BARU: Menonaktifkan reverb (efek gema) untuk track rhythm/chords               ###
        # ####################################################################################
        tracks['rhythm_secondary'].append(Message('control_change', channel=2, control=91, value=0, time=0)) # Reverb Level 0
