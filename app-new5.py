...
'chord_progression': ['C', 'G', 'Am', 'F'],
    ...
    'jazz': {
        ...
        'instruments': {
            ...
            'bass': ['Bass', 'Electric Bass finger'],
        },
        'drums_enabled': True,
...
def get_music_params_from_lyrics(genre, lyrics, user_tempo_input='auto'):
    ...
    logger.info("Parameter instrumental untuk (Mood: {}): Tempo={}BPM, Durasi={} beats".format(
